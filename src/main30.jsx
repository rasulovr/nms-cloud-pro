...
function Settings({ session, t }) {
  ...
  useEffect(() => { load() }, [])
  async function load() {
    const [{ data: u }, { data: le }] = await Promise.all([

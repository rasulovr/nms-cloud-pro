...
const I18N = {
  ru: {
    system_title:'RMS · Restaurant Management System', system_short_title:'RMS', system_subtitle:'Выручка · Финансы · Персонал · Поставщики', dashboard_tab:'Дашборд',
  ...
  az: {
    system_title:'RMS · Restaurant Management System', system_short_title:'RMS', system_subtitle:'Dövriyyə · Maliyyə · Personal · Təchizatçılar', dashboard_tab:'Dashboard',
...
function ProductLogo({ compact = false, login = false }) {
  return <div className={`rms-brandmark ${compact ? 'compact' : ''} ${login ? 'login' : ''}`}>
    <svg className="rms-logo-svg" viewBox="0 0 96 96" aria-hidden="true">
      <defs>
      ...
      <rect x="6" y="6" width="84" height="84" rx="24" fill="url(#rmsBg)" />
      <rect x="12" y="12" width="72" height="72" rx="19" fill="none" stroke="rgba(243,231,212,.18)" strokeWidth="1.4" />
      <path d="M25 68V28h17c8 0 13 4 13 11v4c0 6-4 10-10 11l12 14" fill="none" stroke="url(#rmsAccent)" strokeWidth="4.4" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M39 50h11" fill="none" stroke="url(#rmsAccent)" strokeWidth="4.4" strokeLinecap="round" />
      <path d="M60 68V28l12 20 12-20v40" fill="none" stroke="url(#rmsAccent)" strokeWidth="4.4" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M22 77h52" fill="none" stroke="rgba(243,231,212,.22)" strokeWidth="1.4" strokeLinecap="round" />
    </svg>
    {!compact && <div className="rms-wording"><strong>RMS</strong><small>Restaurant Management System</small></div>}
  </div>
}

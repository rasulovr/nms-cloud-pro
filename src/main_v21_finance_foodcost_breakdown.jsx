...
function Finance({ t, lang }) {
  ...
  async function load() {
    ...
    const marketFoodCost = expenseGroupTotal([...map.entries()].map(([name, amount]) => ({ name, amount })), 'food_market')
    ...
    if (branchId === ALL_BRANCHES) {
      ...
      for (const branch of branches) {
        ...
        const branchMarketFoodCost = expenseGroupTotal([...branchExpenseMap.entries()].map(([name, amount]) => ({ name, amount })), 'food_market')

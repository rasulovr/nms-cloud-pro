...
function ProductLogo({ compact = false, login = false }) {
  return <div className={`rms-brandmark ${compact ? 'compact' : ''} ${login ? 'login' : ''}`}>
    <svg className="rms-logo-svg" viewBox="0 0 128 128" aria-hidden="true">
      <defs>
        <linearGradient id="rmsLogoBg" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0%" stopColor="#24352b" />
          <stop offset="100%" stopColor="#101b15" />
        </linearGradient>
        <linearGradient id="rmsLogoAccent" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0%" stopColor="#d8c29b" />
          <stop offset="100%" stopColor="#f3e7d4" />
        </linearGradient>
      </defs>
      <rect x="8" y="8" width="112" height="112" rx="30" fill="url(#rmsLogoBg)" />
      <rect x="17" y="17" width="94" height="94" rx="23" fill="none" stroke="rgba(243,231,212,.18)" strokeWidth="1.8" />
      <path d="M36 82V45h18c9 0 14 4 14 11 0 6-4 10-11 11l13 15" fill="none" stroke="url(#rmsLogoAccent)" strokeWidth="5.2" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M48 65h14" fill="none" stroke="url(#rmsLogoAccent)" strokeWidth="5.2" strokeLinecap="round" />
      <path d="M69 82V45l13 21 13-21v37" fill="none" stroke="url(#rmsLogoAccent)" strokeWidth="5.2" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M93 48c6-5 17-3 18 5 1 8-14 8-14 16 0 8 11 10 18 4" fill="none" stroke="url(#rmsLogoAccent)" strokeWidth="5.2" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M32 92h64" fill="none" stroke="rgba(243,231,212,.25)" strokeWidth="2" strokeLinecap="round" />
    </svg>
  </div>
}

...
function ThemeStyles() {
  return <style>{`
    ...
    .theme-executive .attendance-card td button { border: 1px solid rgba(100,116,139,.55); }
    ...
    .theme-executive .attendance-card td button:hover { filter: brightness(.98); }
    .theme-executive .attendance-card input { background: #dbe2ea; border-color: #94a3b8; color: #111827; }

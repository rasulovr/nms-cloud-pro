      ...
      {tab === 'legacy' && (
        <section className="tech-modern-page">
          ...
          <div className="tech-modern-layout">
            ...
            <aside className="tech-modern-sidebar tech-ai-sidebar">
              <div className="tech-side-card tech-ai-card">
                <div className="tech-side-title">
                  <h3>AI-инсайты</h3>
                  <span className="ai-badge">AI</span>
                </div>
                <button className="tech-action-line ai-line warning">
                  <span>⚠</span>
                  <div><b>Высокий Food Cost</b><small>У {menuItems.filter(m => parseNum(m.sale_price) > 0).length || 0} позиций нужно проверить маржу.</small></div>
                  <em>›</em>
                </button>
                <button className="tech-action-line ai-line good">
                  <span>↗</span>
                  <div><b>Потенциал маржи</b><small>Проверьте блюда с маржой ниже 60%.</small></div>
                  <em>›</em>
                </button>
                <button className="tech-action-line ai-line info">
                  <span>◔</span>
                  <div><b>Тренд себестоимости</b><small>Следите за ростом закупочных цен.</small></div>
                  <em>›</em>
                </button>
                <button className="tech-all-insights" onClick={() => setTab('final')}>Создать улучшенную тех. карту →</button>
              </div>

              <div className="tech-side-card tech-ai-card">
                <div className="tech-side-title">
                  <h3>Оповещения</h3>
                  <span className="ai-count">3</span>
                </div>
                <div className="tech-alert-row"><i className="red-dot"></i><div><b>Нет компонентов</b><small>Позиции без состава и себестоимости</small></div></div>
                <div className="tech-alert-row"><i className="orange-dot"></i><div><b>Изменение цен</b><small>Проверьте последние закупки</small></div></div>
                <div className="tech-alert-row"><i className="yellow-dot"></i><div><b>Низкая маржа</b><small>Позиции требуют пересмотра</small></div></div>
                <button className="tech-all-insights">Все оповещения →</button>
              </div>
            </aside>
          </div>
        </section>

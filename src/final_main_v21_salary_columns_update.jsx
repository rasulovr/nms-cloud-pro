    ...
    <section className="grid">
      ...
      <div className="card span-2">
        ...
        <div className="table-wrap"><table style={{ tableLayout: 'auto' }}>
          <thead><tr><th>Филиал</th><th>Должность</th><th style={{minWidth:220}}>Сотрудник</th><th>Начислено</th><th>К выплате</th><th>Авансы</th><th>Удержание</th><th>Остаток месяца</th><th>Выплачено</th><th style={{minWidth:130}}>Расчёт</th><th style={{minWidth:110}}>Мес. ставка</th><th style={{minWidth:100}}>Дневная</th><th style={{minWidth:90}}>Дни</th><th style={{minWidth:120}}>Статус</th><th>Долг нач.</th><th>Комментарий</th><th style={{minWidth:150, textAlign:'center'}}>Статус сотрудника</th><th style={{width:54}}>Инфо</th></tr></thead>
              ...
              {groupRows.map(r => {
                ...
                return <React.Fragment key={r.id || r.employee_id}>
                  <tr style={underworked ? { background: 'rgba(155,45,45,.08)' } : undefined}>
                    ...
                    <td><strong>{fmt(r.salary_gross)}</strong></td>
                    ...
                    <td><span className="cell-value">{fmt(r.employees?.monthly_salary)}</span></td>
                    <td><span className="cell-value">{fmt(calcDailyRate(r.employees))}</span></td>
                    <td><span className="cell-value">{fmt(r.worked_days)}</span></td>
                    ...
                    <td>{r.comment || <span className="hint">—</span>}</td>

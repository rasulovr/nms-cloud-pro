...
function Salaries({ t }) {
  ...
  async function addSalaryPayment() {
    ...
    const previousAmount = parseNum(paymentForm.previous_amount)
    ...
    <section className="grid">
      ...
      <div className="card span-2">
        ...
        <div className="form-grid compact">
          ...
          <label><span>Оплата остатка прошлого месяца</span><input inputMode="decimal" value={paymentForm.previous_amount} onChange={e => setPaymentForm({ ...paymentForm, previous_amount: e.target.value })} placeholder="Не попадает в авансы" /></label>

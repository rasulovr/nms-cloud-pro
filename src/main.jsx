...
function ExpenseRow({ expense, categories, focusExpenseId, onSave, onCancel }) {
  const [editing, setEditing] = useState(false)
  ...
  const focused = focusExpenseId && String(focusExpenseId) === String(expense.id)
...
function ThemeStyles() {
  return <style>{`
    ...
    .focus-row { background: rgba(212, 175, 55, .16) !important; box-shadow: inset 4px 0 0 rgba(180, 130, 20, .9); }

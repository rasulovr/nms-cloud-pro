...
function Attendance({ t, mode = 'attendance' }) {
  ...
  async function load() {
    ...
    const visibleEmployees = (employeeSource || []).filter(e => matchesStaffGroup(e, branchId)).filter(e => matchesPositionGroup(e, positionFilter))
...
function Salaries({ t, view = 'employees' }) {
  ...
  async function load() {
    ...
    setRows(mappedRows)
    setSalaryPayments([...(payRows || []), ...(previousDisplayPayRows || [])])
    setSalaryAdvanceRows(advRows || [])

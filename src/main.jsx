...
function ResponsiveAndSettingsStyles() {
  return <style>{`
    ...
    .rms-mark {
      ...
      background: linear-gradient(180deg, #24352b, #17251d);
...
function ProductLogo({ compact = false, login = false }) {
  return <div className={`rms-brandmark ${compact ? 'compact' : ''} ${login ? 'login' : ''}`}>
    <div className="rms-mark"><span>R</span><span>M</span><span>S</span></div>
...
function ThemeStyles() {
  return <style>{`
    ...
    .theme-modern .rms-mark { background: linear-gradient(135deg, #2dd4bf, #0f766e); border-color: rgba(255,255,255,.24); box-shadow: 0 12px 28px rgba(45,212,191,.28); }
    .theme-modern .rms-mark span { color: #052e2b; background: rgba(255,255,255,.72); border-color: rgba(255,255,255,.36); }

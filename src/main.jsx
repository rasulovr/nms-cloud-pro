...
async function rmsCalculateNetworkForecastForMonth(y, m, scopeBranchId = 'all') {
  ...
  const fixedDetails = [
    { name: 'Зарплаты', amount: salaryForecast, note: 'фиксированный фонд активных сотрудников из раздела “Зарплаты”' },
    ...
    { name: 'DSMF', amount: dsmfForecast, note: 'фиксированный расчёт по официальным зарплатам сотрудников' },

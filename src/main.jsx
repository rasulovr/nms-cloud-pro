  ...
  return <section id="dashboardPage" className="rms-executive-dashboard">
    <section className="dashboard-v23-head">
      ...
      <div className="dashboard-v23-filters">
        <label><span>Филиал</span><select value="all" disabled><option value="all">Все рестораны</option></select></label>
    ...
    <section className="dashboard-v23-main-grid">
      <DailyRevenueLineChart
        rows={dailyRevenueRows}
        title="Выручка по дням за выбранный месяц"
        subtitle="Суммарная выручка сети по дням месяца, без Wolt"
        className="dashboard-v23-daily-chart"
    ...
    <section className="dashboard-v23-bottom-grid">

...
function Recipes({ t }) {
  ...
  async function editSelectedSemiLine() {
    const item = selectedSemiItems.find(row => String(row.id) === String(selectedSemiItemId)) || selectedSemiItems[0]
    if (!item) {
      ...
      {tab === 'semis' && (
        <section className="grid semifinished-layout">
          ...
          <div className="card semi-composition-card">
            ...
            <p className="hint">Нажмите на строку, затем кнопку “Изменить выбранный ингредиент”.</p>

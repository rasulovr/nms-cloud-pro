...
function ResponsiveAndSettingsStyles() {
  return <style>{`
    ...
    .rms-clean-logo.login {
      margin: 0 auto 18px;
    }
    .rms-clean-logo.compact {
      width: 48px;
      height: 48px;
      border-radius: 14px;
      background: linear-gradient(180deg, #24352b, #101b15);
    ...
    .rms-clean-logo.compact .rms-clean-mark {
      width: 36px;
      height: 34px;
      margin-bottom: 0;
    }
    .rms-clean-mark::before {
      content: '';
      position: absolute;
      left: 50%;
      top: 0;
    ...
    .rms-clean-logo.compact .rms-clean-mark span {
      top: 11px;
      font-size: 22px;
    }
    .rms-mark-r {
    ...
    .rms-clean-logo.compact .rms-clean-mark i {
      width: 4px;
      height: 16px;
      bottom: 1px;
    }
    ...
    .login-card button.primary {
      ...
      font-size: 20px;
      color: #fff;
      background: linear-gradient(135deg, #b5924b, #d6bb76);
      box-shadow: 0 14px 28px rgba(181,146,75,.18);
    }
...
function ProductLogo({ compact = false, login = false }) {
  return <div className={`rms-clean-logo ${compact ? 'compact' : ''} ${login ? 'login' : ''}`}>
    <div className="rms-clean-mark">
      <span className="rms-mark-r">R</span>
      <span className="rms-mark-s">S</span>
      <i></i>
    </div>
    {!compact && <div className="rms-clean-word">RMS</div>}
    {!compact && <div className="rms-clean-sub">Restaurant Management System</div>}
  </div>
}
...
function Login({ lang, setLang, t }) {
  ...
  return <div className="login-screen"><div className="login-card">
    ...
    <p>Вход по внутреннему login.<br />Допустим вход по логину без домена.</p>

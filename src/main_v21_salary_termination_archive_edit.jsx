  ...
  return <section>
    ...
    <section className="grid">
      ...
      <div className="card span-2">
        ...
        <div className="table-wrap"><table>
          <thead><tr><th>Филиал / группа</th><th>Должность</th><th>Сотрудник</th><th>Дата приёма</th><th>Дата увольнения</th><th>Статус</th><th>Инфо</th></tr></thead>
          <tbody>{archiveRows.map(r => {
            ...
            return <React.Fragment key={`archive-${r.employee_id}`}>
              ...
              {isInfoOpen && <tr><td colSpan="7"><div className="notice">
                <div className="card-head">
          ...
          })}{!archiveRows.length && <tr><td colSpan="7" className="hint">Архив пуст.</td></tr>}</tbody>
        </table></div>
      </div>

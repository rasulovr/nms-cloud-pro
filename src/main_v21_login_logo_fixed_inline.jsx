...
function ProductLogo({ compact = false, login = false }) {
  const size = login ? 92 : 48
  return <div style={{ width: size, height: size, margin: login ? '0 auto 18px' : 0, display: 'flex', alignItems: 'center', justifyContent: 'center', flex: '0 0 auto' }}>
    <svg width={size} height={size} viewBox="0 0 96 96" aria-hidden="true" style={{ display: 'block' }}>
      <defs>
        <linearGradient id="rmsMarkBg" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0%" stopColor="#17382b" />
          <stop offset="100%" stopColor="#0d1712" />
        </linearGradient>
        <linearGradient id="rmsMarkGold" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0%" stopColor="#b99b56" />
          <stop offset="100%" stopColor="#ddc485" />
        </linearGradient>
      </defs>
      <rect x="10" y="10" width="76" height="76" rx="22" fill="url(#rmsMarkBg)" />
      <path d="M29 68V31h17c8 0 13 4 13 11v3c0 6-4 10-10 11l11 12" fill="none" stroke="#e9dcc6" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M42 53h12" fill="none" stroke="#e9dcc6" strokeWidth="6" strokeLinecap="round" />
      <path d="M61 68V31l11 18 11-18v37" fill="none" stroke="#e9dcc6" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M28 78h40" fill="none" stroke="url(#rmsMarkGold)" strokeWidth="3" strokeLinecap="round" opacity=".8" />
    </svg>
  </div>
}
...
function Login({ lang, setLang, t }) {
  ...
  return <div className="login-screen"><div className="login-card">
    <ProductLogo login />
    <h1 style={{ margin: 0, textAlign: 'center', fontSize: 42, lineHeight: 1, letterSpacing: '.12em', fontWeight: 900 }}>{t('system_title')}</h1>
    <p style={{ margin: '14px 0 34px', textAlign: 'center', color: 'var(--muted)', fontSize: 18, lineHeight: 1.35 }}>{t('brand_subtitle')}</p>
    <p style={{ margin: '0 0 34px', textAlign: 'center', color: 'var(--muted)', fontSize: 17, lineHeight: 1.55 }}>Вход по внутреннему login.<br />Допустим вход по логину без домена.</p>

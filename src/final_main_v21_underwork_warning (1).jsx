    ...
    <section className="grid">
      ...
      <div className="card span-2">
        ...
        <div className="table-wrap"><table style={{ tableLayout: 'auto' }}>
          <thead><tr><th>Филиал</th><th>Должность</th><th style={{minWidth:220}}>Сотрудник</th><th style={{width:54}}>Инфо</th><th>Расчёт</th><th>Мес. ставка</th><th>Дневная</th><th style={{minWidth:90}}>Дни</th><th style={{minWidth:120}}>Статус</th><th>Долг нач.</th><th>Начислено</th><th>Авансы</th><th>Удержание</th><th>Остаток месяца</th><th>Выплачено</th><th>Баланс</th><th>Комментарий</th></tr></thead>
          <tbody>{rows.map(r => {
            ...
            {employeeInfoId === r.employee_id && <tr><td colSpan="17"><div className="notice">
          ...
          })}{!rows.length && <tr><td colSpan="17" className="hint">Нет активных сотрудников.</td></tr>}</tbody>
        </table></div>
      </div>

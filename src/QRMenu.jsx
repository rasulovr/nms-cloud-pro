    ...
    <section className="qr-panel">
      ...
      {loadingBill ? (
        ...
        <>
          ...
          {!billItems.length ? (
            <div className="qr-empty">
              <h3>Позиции пока не добавлены</h3>
              <p>Счёт открыт, но блюда ещё не переданы в таблицу rms_qr_live_bill_items.</p>
            </div>
          ) : (
          ...
          <div className="qr-payment-box">
            {!showPaymentChoice ? (
              <button onClick={() => setShowPaymentChoice(true)}>Оплатить</button>
            ) : (
              <>

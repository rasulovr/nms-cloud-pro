...
function DebtsPayments({ t }) {
  ...
  const transactionSourceCount = transactionType === 'purchases' ? filteredPurchases.length : transactionType === 'payments' ? filteredPayments.length : productPriceRows.length
  ...
  const pagedFilteredPurchases = filteredPurchases.slice(transactionStart, transactionStart + transactionPageSize)

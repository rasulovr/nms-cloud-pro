    ...
    <div className="loyalty-scan-page">
      <section className="loyalty-scan-hero">
        <div>
          ...
          <p>Официант открывает этот раздел на телефоне и сканирует QR-код гостя из QR Menu через live camera или фото-режим.</p>
        </div>
      ...
      <section className="loyalty-scan-grid">
        <div className="loyalty-scan-card">
          ...
          <p>Откройте этот экран на телефоне официанта/планшете. Используйте Live scan на Android/Chrome или режим фото/камеры на iPhone.</p>
          ...
          <div className="loyalty-camera-actions">
            ...
            />
            {!cameraOpen ? (
              <button className="loyalty-scan-primary" onClick={startCamera}>Live scan камерой</button>
            ) : (
              <button className="loyalty-scan-secondary" onClick={stopCamera}>Закрыть live scan</button>
            )}
            <button className="loyalty-scan-secondary" onClick={openPhotoScanner}>Сканировать из фото/камеры</button>
          </div>

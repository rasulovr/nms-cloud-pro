...
import { formatMenuCategory, formatMenuDescription, resolveReferenceCategory, resolveReferenceMenuProduct } from "./referenceMenuCatalog";
...
export function localizeCategory(category, language) {
  ...
  return formatMenuCategory(value, language === "az" ? "az-AZ" : language === "en" ? "en-US" : "ru-RU");
}

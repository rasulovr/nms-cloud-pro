...
function SalaryWorkspace({ t }) {
  ...
  return (
    <section>
      ...
      {salaryTab === 'employees' && <Salaries t={t} view="employees" />}
      {salaryTab === 'attendance' && <Attendance t={t} />}
    ...
    <section className="grid">
      ...
      <div className="card span-2">
        ...
        {selectedPaymentRow && <div className="mini-grid" style={{marginTop:12}}>
          <div className="metric"><span>Долг / остаток прошлого месяца</span><strong className={selectedOpeningDebt > 0 ? 'bad' : ''}>{selectedPaymentCanSee ? fmt(selectedOpeningDebt) : maskedMoney}</strong></div>
